"""Package and check the fresh native M1.6 mounting-hole CAM export."""
...
code=code.replace('94 through plated holes','96 through plated holes').replace('40 x 0.75 mm, 4 x 2.1 mm, 2 x 4.0 mm).','40 x 0.75 mm, 2 x 1.8 mm, 4 x 2.1 mm, 2 x 4.0 mm).')
code=code.replace('DC traces, pin mapping and RF geometry are unchanged.',
    'DC traces, pin mapping and RF geometry are unchanged.\nTwo M1.6 mounts: 1.8 mm plated drill, 2.2 mm land, solid GND.\nCenters X1.60 / X17.90, Y1.20 mm; 16.30 mm pitch.\nNo mounting-hole thermal relief or solder paste.')
