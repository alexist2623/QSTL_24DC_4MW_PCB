...
Procedure MarkConn(S:String);Begin ConnLog.Add(S);ConnLog.SaveToFile(ConnPath+'work\rc_mask_clearance_reopen_check.txt');End;
...
Begin
 ...
 Good:=B.RunBatchDesignRuleCheck(ConnPath+'docs\RC_Mask_Clearance_DRC.html',eDRC_HTML,False,False);
