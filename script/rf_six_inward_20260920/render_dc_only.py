...
text(40,22,'층 전환 비아 없이 중앙으로 모은 DC',32,'#ffffff',True)
...
def panel(origin,bounds,scale,mode):
 ...
 for c in n['components']:
  if c['designator'] in ['R1','R2','R3','R4','R5','R6'] and inside(c['x'],c['y'],2):
 ...
 if mode in ['overview','detail']:
  ...
  if mode=='detail':
   ...
   for name,x,y in [('R4',6.7,47.2),('R3',13.0,47.2),('R2',17.0,42.9),('R6',2.7,42.3),('R1',15.8,31.3),('R5',4.7,31.3)]:
