...
Procedure MarkConn(S:String);Begin ConnLog.Add(S);ConnLog.SaveToFile(ConnPath+'work\rf6_reopen_check.txt');End;
...
Begin
 ...
 Good:=B.RunBatchDesignRuleCheck(ConnPath+'docs\RF6_DRC.html',eDRC_HTML,False,False);
