...
- RF fence: nominal 0.15 mm land-edge gap (0.40 mm centre-to-centre chord). Straight sections have 0.510 mm centre offset: 0.055 mm half-trace + 0.330 mm copper-edge gap + 0.125 mm land radius. Equal-angle 14-position grids surround each active SMP centre; only two symmetric RF-exit positions are omitted, leaving 12 vias and approximately 0.425 mm centre chords, with the same nominal 0.330 mm gap from the signal-pad copper edge.
