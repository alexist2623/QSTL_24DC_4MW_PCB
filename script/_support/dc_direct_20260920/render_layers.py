...
for col,layer in enumerate([32,4,2]):
 ...
 text(ox,148,{32:'L6 · RF 4개',4:'L4 · DC' ,2:'L2 · DC'}[layer],25,color,True)
 ...
 text(ox+9.75*scale,oy+(67.9-61.5)*scale,'부품·패드 위치 유지',16,'#7898a9',anchor='mt')
 if layer==32:
  for i in range(1,5):
 ...
 text(ox+9.75*scale,1450,{32:'SMP → C → R 패드 → QD',4:'중앙 12개 + ZIF23 층 전환',2:'중앙 12개 / 선폭 0.125 mm'}[layer],16,color,anchor='mt')
