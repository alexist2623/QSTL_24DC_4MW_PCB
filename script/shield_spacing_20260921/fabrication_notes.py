...
- RF fence: nominal 0.15 mm land-edge gap (0.40 mm centre-to-centre chord). Straight sections have 0.510 mm centre offset: 0.055 mm half-trace + 0.330 mm copper-edge gap + 0.125 mm land radius. Circular blind-via fences surround each active SMP signal centre, with local gaps at RF exits and through holes, with the same nominal 0.330 mm gap from the signal-pad copper edge.
