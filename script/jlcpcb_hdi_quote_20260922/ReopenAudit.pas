...
Procedure MarkConn(S:String);Begin ConnLog.Add(S);ConnLog.SaveToFile(ConnPath+'fabrication\JLCPCB_HDI_20260922\reopen_check.txt');End;
...
Begin
 ...
 Good:=B.RunBatchDesignRuleCheck(ConnPath+'fabrication\JLCPCB_HDI_20260922\Native_DRC.html',eDRC_HTML,False,False);
