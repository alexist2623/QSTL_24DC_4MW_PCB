...
reader = PdfReader(OUT / 'QSTL_Split_Mount_RevD.pdf')
...
readme = '''# Split mounting plate drawings - Rev D
...
files = [OUT / f'QSTL_Split_Mount_RevD_QSTL-{code}.dwg' for code in ['CP01','CP02','LS01','RS01','AS01']]
files += [OUT / name for name in ['QSTL_Split_Mount_RevD_Inventor.dwg', 'QSTL_Split_Mount_RevD.idw',
          'QSTL_Split_Mount_RevD.pdf', 'Split_Mount_Assembly.ipn', 'Split_Mount_Plate_Only.iam',
