...
Procedure MarkConn(S:String);Begin ConnLog.Add(S);ConnLog.SaveToFile(ConnPath+'work\lower_rc_70pct_reopen_check.txt');End;
...
Begin
 ...
 Good:=B.RunBatchDesignRuleCheck(ConnPath+'docs\Lower_RC_70pct_DRC.html',eDRC_HTML,False,False);
