...
reader = PdfReader(OUT / 'QSTL_Split_Mount_RevC.pdf')
...
readme = '''# Split mounting plate drawings - Rev C
...
- Manufacturing_DWG/QSTL_Split_Mount_RevC_QSTL-CP01.dwg: central plate overall and hole-pattern dimensions.
- Manufacturing_DWG/QSTL_Split_Mount_RevC_QSTL-CP02.dwg: central plate thread and countersink sections.
- Manufacturing_DWG/QSTL_Split_Mount_RevC_QSTL-LS01.dwg and RS01.dwg: separate support drawings.
- Manufacturing_DWG/QSTL_Split_Mount_RevC_QSTL-AS01.dwg: native presentation-linked exploded assembly, eight fastening axes, assembled boss-side view and fastening section C-C.
- Manufacturing_DWG/QSTL_Split_Mount_RevC_Inventor.dwg: combined five-sheet master.
- Manufacturing_DWG/QSTL_Split_Mount_RevC.pdf: print-layout companion.
...
files = [OUT / f'QSTL_Split_Mount_RevC_QSTL-{code}.dwg' for code in ['CP01','CP02','LS01','RS01','AS01']]
files += [OUT / name for name in ['QSTL_Split_Mount_RevC_Inventor.dwg', 'QSTL_Split_Mount_RevC.idw',
          'QSTL_Split_Mount_RevC.pdf', 'Split_Mount_Assembly.ipn', 'Split_Mount_Plate_Only.iam',
...
files += [MODEL / 'support_flange_2mm_validation.json', MODEL / 'support_native_reopen.json', OUT / 'Split_Mount_Plate_Only.step']
archive = MODEL / 'QSTL_Plate_DWG_Package_RevC.zip'
