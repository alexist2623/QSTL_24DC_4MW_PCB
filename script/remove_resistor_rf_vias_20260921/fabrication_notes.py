...
- Remove C1-C6 pad through-vias: both capacitor terminals are routed on L6. Preserve normal capacitor pads and stencil apertures. Preserve QD via-in-pad and one DC-side via on pad 2 of each R1-R6. Remove all six unused RF-side resistor pad 1 vias; their RF path remains on L6.
