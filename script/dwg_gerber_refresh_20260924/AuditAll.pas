...
Procedure MarkConn(S:String);Begin ConnLog.Add(S);ConnLog.SaveToFile('C:\JeonghyunPark\Workspace\QSTL_24DC_4MW_PCB\script\dwg_gerber_refresh_20260924\reopen_check.txt');End;
...
Begin
 ...
 Good:=B.RunBatchDesignRuleCheck(ConnPath+'fabrication\JLCPCB_HDI_20260924\Native_DRC.html',eDRC_HTML,False,False);
...
Begin
 ...
 L.Add('COMPLETE');L.SaveToFile('C:\JeonghyunPark\Workspace\QSTL_24DC_4MW_PCB\script\dwg_gerber_refresh_20260924\native_paste_audit.txt');L.Free;
End;
...
Begin
    ...
    DraftCompileReport:='C:\JeonghyunPark\Workspace\QSTL_24DC_4MW_PCB\script\dwg_gerber_refresh_20260924\schematic_compile.txt';
    WS := GetWorkspace;
    If WS = Nil Then Exit;
